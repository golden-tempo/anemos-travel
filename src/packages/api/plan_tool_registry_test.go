...
func TestPlanSessionToolsOrderStable(t *testing.T) {
	...
	cases := []struct {
		...
		//
		// the authed-gated set_* family tail-appends; set_leg_gateway is last
		...
		{"authed", &planSession{authed: true},
			append(append([]string{}, base...), "create_itinerary", "save_preferences", "get_trip",
				"add_booking_todo", "update_booking_todo", "remove_booking_todo", "add_packing_item", "set_travel_mode", "suggest_replies", "search_nearby", "find_parking", "set_trip_dates", "set_leg_dates", "set_trip_origin", "set_leg_transport_mode", "search_hotels", "set_trip_description", "migrate_booking_todo", "shift_days_from", "set_leg_gateway")},
		{"authed trip-bound", &planSession{authed: true, boundTripID: &tid},
			append(append([]string{}, base...), "update_itinerary_section", "save_preferences", "get_trip",
				...
				"add_accommodation", "add_transport_segment", "move_itinerary_item", "set_travel_mode", "suggest_replies", "search_nearby", "find_parking", "set_trip_dates", "set_leg_dates", "set_trip_origin", "set_leg_transport_mode", "search_hotels", "set_trip_description", "replace_leg", "migrate_booking_todo", "shift_days_from", "set_leg_gateway")},
	}
